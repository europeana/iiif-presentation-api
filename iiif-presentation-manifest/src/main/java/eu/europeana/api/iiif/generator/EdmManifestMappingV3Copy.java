...
public final class EdmManifestMappingV3Copy implements ManifestGenerator<Manifest> {

    private static final Logger LOG = LogManager.getLogger(EdmManifestMappingV3Copy.class);

    private ManifestSettings     settings;
    private MediaTypeCatalog       mediaTypes;

    public EdmManifestMappingV3Copy(ManifestSettings settings
...
//        manifest.setPartOf(getWithinV3(jsonDoc));
     ...
     * @return
     */
    private static MediaType ifEuScreenGetMediaType(MediaTypeCatalog mediaTypes, Object jsonDoc, String europeanaId, String isShownBy) {
     ...
     */
    static List<Canvas> getItems(ManifestSettings settings, MediaTypeCatalog mediaTypes, String europeanaId, String isShownBy, Object jsonDoc, MediaType euScreenTypeHack) {
        ...
        if (sortedResources.isEmpty()) { return null; }
    ...
    private static ContentResource getAnnotationBody(WebResource webResource, MediaType mediaType,
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Instantiated {} Annotation Body with the media type {}", annoBody.getClass().getName(), mediaType.getCategory());
        }
    ...
    private static void setServiceIdForAnnotation(String europeanaId, WebResource webResource,
        ...
        if (serviceId != null) {
            Service service = new Service(serviceId, GeneratorConstants.IMAGE_SERVICE_TYPE_3);

...
public class RecordConstants {
    ...
    public static final String EDM_NEXT_IN_SEQUENCE = "isNextInSequence";
    public static final String DCTERMS_CONFORMS_TO = "dctermsConformsTo";
    public static final String DOAP_IMPLEMENTS = "doapImplements";
